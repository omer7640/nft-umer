      ...
      <div className="py-2 mt-3 flex justify-between rounded-xl px-3 bg-zinc-800 items-center">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="btn-div">
            <button
              onClick={() => value.deleteNft(nft.id)}
              type="button"
            ...
            <button
              onClick={() => value.handleEditClick(nft)}
              class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-0.5 me-1 mb-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            >
              <AddNft edit={true} />
            </button>
          </div>
